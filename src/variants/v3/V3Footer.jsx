  ...
  return (
    <footer style={{ borderTop: '1px solid #e8e8e8', background: '#fff' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '64px 40px 40px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 60, marginBottom: 48 }}>
          <div>
          ...
          <div>
            ...
            <p style={{ fontSize: 13, color: '#777', lineHeight: 1.7, marginBottom: 8 }}>
              {t('footer.imprintText')}
            </p>
            <details style={{ fontSize: 13 }}>
              <summary style={{ color: '#aaa', cursor: 'pointer' }}>{t('footer.imprintToggle')}</summary>
              <p style={{ color: '#777', lineHeight: 1.7, whiteSpace: 'pre-line', marginTop: 12 }}>
                {t('footer.imprintDetails')}
              </p>
            </details>
          </div>
          ...
          <div>
            ...
            <a
              ...
              style={{ fontSize: 13, color: '#777', lineHeight: 1.7, textDecoration: 'underline' }}
            >
              {t('footer.privacyDfjwLink')}
            </a>
            <details style={{ fontSize: 13, marginTop: 8 }}>
              <summary style={{ color: '#aaa', cursor: 'pointer' }}>{t('footer.privacyToggle')}</summary>
              <p style={{ color: '#777', lineHeight: 1.7, whiteSpace: 'pre-line', marginTop: 12 }}>
                {t('footer.privacyDetails')}
              </p>
            </details>
          </div>
        </div>
